...
import type { PostOutput, PostListOutput, PostDetailsOutput, PostListPublishedOutput, PostDetailPublishedOutput } from "../dto/post.output.js"
...
export function toPostLisPublishedtOutput (post: PostListPublishedOutput)  {
    const props = post
    return {
        title:props.title,
        id:props.id,
