...
export function authorRoutes(app) {
    ...
    app.register(async (protectedRoutes) => {
        ...
        protectedRoutes.post("/authors", { preHandler: requirePermission("AUTHOR_CREATE") }, createAuthorController.handle.bind(createAuthorController));
        protectedRoutes.put("/authors/:id", { preHandler: requirePermission("AUTHOR_UPDATE") }, updateAuthorController.handle.bind(updateAuthorController));
    });
