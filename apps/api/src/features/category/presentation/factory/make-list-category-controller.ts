import { ListaCategoryController } from "../http/controllers/ListCategoryController.js";
...
export function makeListCategoryController(){
    ...
    const listaCategoryController = new ListaCategoryController(listCategoryUseCase)
